...
result_subtr = min(result_subtr)-max(result_subtr)
#  или можно в простом виде result_subtr = item_2 - item_1
...
# 19. Присвоить переменной item_1 odd значение (т.е. не четное число)
item_1 = 53

# 20. Присвоить переменной item_2 even значение (т.е. четное число)
item_2 = 14
...
try:
    ...
    print('57. b_item_relult_division =', 'Ошибка. Деление на ноль не возможно')
